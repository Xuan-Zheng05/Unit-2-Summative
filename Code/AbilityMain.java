...
public static Ability[] kayo() {
		
		// Kay/o abilities
		Ability fragment = new Ability("Frag/ment", 200, 60, 1, false, false, false, false, false, false, false, false, false);
		Ability flashDrive = new Ability("Flash/Drive", 250, 0, 2, true, false, false, false, false, false, false, false, false);
		Ability zeroPoint = new Ability("Zero/Point", 0, 0, 1, false, false, false, false, false, true, false, false, false);
		Ability nullCmd = new Ability("Null/CMD", 0, 0, 1, false, false, false, false, false, false, false, false, true);
		Ability[] kayoAbilities= {fragment, flashDrive, zeroPoint, nullCmd};
		return kayoAbilities;
