...
public class AgentMain {
   ...
   static Skin none = new Skin("None", "Default", false, 0);
   ...
   public static Agent[] List() {
      Agent[] AgentList = new Agent[] { Astra(), BrimeStone(), Viper(), Cypher(), Sova(), Sage(), Phoneix(), Jett(),
            Reyna(), Raze(), Breach(), Skye(), Yoru(), KAYO(), Chamber(), Neon(), Fade() };
      return AgentList;
   }
